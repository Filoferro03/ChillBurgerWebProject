...
async function getProductsInCart(order) {
  ...
  for (let i = 0; i < products.length; i++) {
    ...
    <a href="menu.php#${product.idprodotto}">
        <img src="${product.image}" class="col-10 m-2 rounded-3" alt="${
      product.nome
    }">
    </a>
</div>
                ...
                <div class="d-flex w-100 h-100 flex-column justify-content-between p-1">
                    <div class="d-flex flex-column w-100 m-1">
                        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-center">
                            ...
                            <div class="d-flex align-items-center">
                                <p class="fs-3">${(price * quantita).toFixed(
                                  2
                                )}€</p>
                            </div>
                    ...
                    <div class="d-flex justify-content-center justify-content-md-end pb-3">
                        <button class="btn btn-danger btn-remove" data-id="${
                          product.idprodotto
                        }" data-type="product" ${disableRemove}>
                            Rimuovi
                        </button>
                    </div>
                </div>
  ...
  for (let i = 0; i < personalizations.length; i++) {
    ...
    <div class="d-flex flex-column flex-md-row align-items-center justify-content-md-between col-12 border-bottom border-dark mb-2">
        <div class="d-flex flex-column align-items-center col-8 col-md-3 m-1">
    <a href="burger-details.php?id=${personalization.idprodotto}">
        <img src="${personalization.image}" class="col-10 m-2 rounded-3" alt="${
      personalization.nomeprodotto
    }">
    </a>
</div>
        ...
        <div class="d-flex w-100 h-100 flex-column justify-content-between p-1">
            <div class="d-flex flex-column w-100">
                    ...
                    <div class="d-flex flex-column align-items-center">
                        <div class="d-flex flex-row justify-content-between align-items-center">
                            <button type="button" class="btn p-1 p-md-3 md:m-1" ${disableMinusPers}
                                onclick="modifyPersonalizationQuantity(${
                                  personalization.idpersonalizzazione
                                }, -1)">
                                <span class="fa-solid fa-circle-minus icon" aria-hidden="true"></span>
                            </button>
                            <p class="fs-3"><span class="quantita">${quantita}</span></p>
                ...
                <div class="d-flex justify-content-between d-lg-none mt-2">
                    <a href="./edit-burger.php?id=${
                      personalization.idpersonalizzazione
                    }">
                        <button class="btn btn-success w-10" data-id="${
                          personalization.idpersonalizzazione
                        }" ${disableMinusPers}>Modifica</button>
                    </a>
                    <button class="btn btn-danger btn-remove" data-id="${
                      personalization.idpersonalizzazione
                    }" data-type="personalization" ${disableRemovePers}>
                        Rimuovi
                    </button>
                </div>
  ...
  result += `
        <div class="d-flex flex-column w-100 mt-5">
            <div class="d-flex justify-content-between">
                ...
                <p class="fs-3">${(order[0].prezzo_totale - 2.5).toFixed(
                  2
                )}€</p>
            </div>
  ...
  document.querySelectorAll(".btn-remove").forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      newBtn.addEventListener("click", async () => {
        ...
        formData.append(
          "action",
          type === "product" ? "removeProd" : "removePers"
        );
        formData.append(
