...
const ingredients = [
  ...
  let products = [
    {
      ...
      ingredients: ['Hamburger di manzo', 'Pane', 'Cheddar', 'Bacon', 'Salsa barbecue']
    },
    {
      id: 2,
      name: 'Green Garden',
  ...
  function createProductCard (prod) {
    ...
    body.appendChild(createEl('p', 'text-sm text-gray-600 mb-2', '€ ' + prod.price.toFixed(2)));
  ...
  $('#add-product-form').addEventListener('submit', e => {
    ...
    fetch('/api/api-manager-menu.php', {method:'POST', body:JSON.stringify(newProduct)})
