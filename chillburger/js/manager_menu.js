...
(() => {
  ...
  // Pulsante MODIFICA: ora viene aggiunto per TUTTE le categorie
  ...
  infoDiv.append(createEl('p', { class: 'text-muted mb-0' }, 'Gli ingredienti non sono modificabili per questa categoria di prodotto.'));
  form.append(infoDiv);
   }
  ...
  if (isPaniniCategory && paniniCategoryId && updatedCategoryId === paniniCategoryId) {
