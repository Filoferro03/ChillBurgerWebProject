...
<section class="container py-5">
    ...
    <div class="row g-4" id="menuGrid">
        ...
        $prodotti = [
            [
                "cat" => "burger",
                "img" => "./resources/menu/stock.jpg",
                "nome" => "Classic Burger",
                "desc" => "Manzo 150 g • Cheddar • Salsa house",
                "prezzo" => "8,90 €"
            ],
            [
                "cat" => "burger",
                "img" => "./resources/menu/stock.jpg",
                "nome" => "Double Smash",
                "desc" => "Doppio manzo • Bacon croccante",
                "prezzo" => "11,50 €"
            ],
            [
                "cat" => "fries",
                "img" => "./resources/menu/stock.jpg",
                "nome" => "Patatine Rustiche",
                "desc" => "Patate fresche con buccia",
                "prezzo" => "3,50 €"
            ],
            [
                "cat" => "drink",
                "img" => "./resources/menu/stock.jpg",
                "nome" => "Cola Bio 33 cl",
                "desc" => "Dolcificata con zucchero di canna",
                "prezzo" => "2,50 €"
            ],
        ];
