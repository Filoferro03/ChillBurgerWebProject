<!-- chillburger/template/manager-edit-burger-main.php -->
      ...
      <div class="card shadow">
        <div class="card-body p-4">
          <form id="product-form" enctype="multipart/form-data">
            <!-- Campo nascosto per l'ID del prodotto (solo per modifica) -->
            ...
            <!-- Disponibilità (solo per prodotti non-panini) -->
            ...
            <div class="mb-3">
              ...
              <div class="form-text" id="category-help-text" style="display: none;">
                La categoria non può essere modificata per prodotti esistenti.
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text" id="image-help-text" style="display: none;">
                L'immagine non può essere modificata per prodotti esistenti.
              </div>
              <div class="mt-3" id="current-image-container" style="display: none;">
                <label class="form-label">Immagine attuale:</label>
                <div>
                  <img id="current-image" class="img-fluid rounded" style="max-height: 200px;" alt="Immagine attuale">
                </div>
              </div>
              <div class="mt-3" id="image-preview-container" style="display: none;">
                <label class="form-label">Anteprima:</label>
                <div>
                  <img id="image-preview" class="img-fluid rounded" style="max-height: 200px;" alt="Anteprima immagine">
                </div>
              </div>
            </div>

            <!-- Ingredienti (solo per panini) -->
            <div class="mb-4" id="ingredients-section" style="display: none;">
              ...
              <div id="ingredients-container" class="border rounded p-3 bg-light">
                ...
                <div id="ingredients-loading" class="text-center text-muted">
                  Caricamento ingredienti...
                </div>
                <div id="ingredients-error" class="text-danger" style="display: none;">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
              <button type="button" id="btn-cancel" class="btn btn-outline-secondary me-md-2">
                Annulla
              </button>
