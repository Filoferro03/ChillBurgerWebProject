<section class="container py-5">
    ...
    <div class="card shadow-lg rounded-3 p-4 p-md-5">
            ...
            <section>
                <div class="table-responsive rounded-3 shadow-sm border">
                    <table class="table table-hover mb-0">
                        <thead class="table-light">
                            <tr>
                                <th scope="col" class="py-3 px-4 text-start text-uppercase small text-secondary rounded-top-start">Prodotto</th>
                                <th scope="col" class="py-3 px-4 text-start text-uppercase small text-secondary">SKU</th>
                                ...
                                <th scope="col" class="py-3 px-4 text-start text-uppercase small text-secondary rounded-top-end">Stato</th>
                                <th scope="col" class="py-3 px-4 text-end rounded-top-end">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="py-3 px-4 small text-secondary">WH-BT-200</td>
                                <td class="py-3 px-4 small text-secondary">Elettronica</td>
                                <td class="py-3 px-4 text-dark fw-bold">85</td>
                                <td class="py-3 px-4">
                                    <span class="badge rounded-pill status-in-stock">
                                        In Magazzino
                                    </span>
                                </td>
                                <td class="py-3 px-4 text-end">
                                    <a href="#" class="text-primary me-3">Modifica Quantità</a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="py-3 px-4">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-3">
                                            <img class="rounded-circle object-fit-cover" style="width: 40px; height: 40px;"
                                                 src="https://placehold.co/40x40/FCE7D7/D97706?text=P2"
                                                 alt="Immagine Prodotto">
                                        </div>
                                        <div>
                                            <div class="fw-medium text-dark">Chicchi di Caffè Biologico (1kg)</div>
                                            <div class="small text-secondary">Miscela Arabica</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="py-3 px-4 small text-secondary">CF-ORG-1KG</td>
                                <td class="py-3 px-4 small text-secondary">Cibo e Bevande</td>
                                <td class="py-3 px-4 text-dark fw-bold">7</td>
                                <td class="py-3 px-4">
                                    <span class="badge rounded-pill status-low-stock">
                                        Bassa Scorta
                                    </span>
                                </td>
                                <td class="py-3 px-4 text-end">
                                    <a href="#" class="text-primary me-3">Modifica Quantità</a>
                                    <a href="#" class="text-info">Modifica</a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="py-3 px-4">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-3">
                                            <img class="rounded-circle object-fit-cover" style="width: 40px; height: 40px;"
                                                 src="https://placehold.co/40x40/FEE2E2/EF4444?text=P3"
                                                 alt="Immagine Prodotto">
                                        </div>
                                        <div>
                                            <div class="fw-medium text-dark">T-Shirt Classica da Uomo (Large)</div>
                                            <div class="small text-secondary">Blu Navy</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="py-3 px-4 small text-secondary">TS-M-L-NVY</td>
                                <td class="py-3 px-4 small text-secondary">Abbigliamento</td>
                                <td class="py-3 px-4 text-dark fw-bold">0</td>
                                <td class="py-3 px-4">
                                    <span class="badge rounded-pill status-out-of-stock">
                                        Esaurito
                                    </span>
                                </td>
                                <td class="py-3 px-4 text-end">
                            ...
                            <tr>
                                <td class="py-3 px-4">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-3">
                                            <img class="rounded-circle object-fit-cover" style="width: 40px; height: 40px;"
                                                 src="https://placehold.co/40x40/E0F2F7/0288D1?text=P4"
                                                 alt="Immagine Prodotto">
                                        </div>
                                        <div>
                                            <div class="fw-medium text-dark">Sedia da Ufficio Ergonomica</div>
                                            <div class="small text-secondary">Rete Nera</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="py-3 px-4 small text-secondary">OC-ERG-BLK</td>
                                <td class="py-3 px-4 small text-secondary">Articoli per la Casa</td>
                                <td class="py-3 px-4 text-dark fw-bold">25</td>
                                <td class="py-3 px-4">
                                    <span class="badge rounded-pill status-in-stock">
                                        In Magazzino
                                    </span>
                ...
                <nav class="d-flex justify-content-between align-items-center mt-4 p-3 bg-white rounded-bottom-3 border-top" aria-label="Paginazione">
                    ...
                    <div class="d-none d-sm-flex flex-grow-1 justify-content-between align-items-center">
                        ...
                        <ul class="pagination mb-0">
                            ...
                            <li class="page-item d-none d-md-block"><a class="page-link" href="#">3</a></li>
                            <li class="page-item disabled"><span class="page-link">...</span></li>
                            <li class="page-item d-none d-md-block"><a class="page-link" href="#">9</a></li>
